...
// Sample zones (districts) for each state
export const stateZones: Record<string, string[]> = {
  "Andhra Pradesh": [
  ...
  "Karnataka": [
    ...
    "Bidar", "Chamarajanagar", "Chikmagalur", "Chitradurga", "Dakshina Kannada",
    "Davanagere", "Dharwad", "Gadag", "Gulbarga", "Hassan", "Haveri",
    "Kodagu", "Kolar", "Koppal", "Mandya", "Mysore", "Raichur", "Shimoga",
...
// Sample branches (villages/localities) for each zone
export const zoneBranches: Record<string, string[]> = {
  // Andhra Pradesh - Anantapur
  "Anantapur": ["Agali", "Amarapuram", "Brahmasamudram", "Gooty", "Guntakal", "Hindupur", "Kadiri", "Kalyandurg"],
  // Andhra Pradesh - Chittoor
  "Chittoor": ["Chandragiri", "Chittoor", "Madanapalle", "Palamaner", "Punganur", "Puttur", "Srikalahasti", "Tirupati"],
  // Telangana - Hyderabad
  "Hyderabad": ["Ameerpet", "Banjara Hills", "Begumpet", "Charminar", "Gachibowli", "Hitech City", "Kukatpally", "Madhapur", "Miyapur", "Secunderabad"],
  // Telangana - Rangareddy
  "Rangareddy": ["Chevella", "Ibrahimpatnam", "Maheshwaram", "Shamshabad", "Vikarabad"],
  // Karnataka - Bangalore Urban
  "Bangalore Urban": ["Banashankari", "Bellandur", "Electronic City", "HSR Layout", "Indiranagar", "Jayanagar", "Koramangala", "Marathahalli", "Whitefield", "Yelahanka"],
  // Karnataka - Mysore
  "Mysore": ["Bannur", "Hunsur", "K.R. Nagar", "Mysore City", "Nanjangud", "Periyapatna", "T. Narasipura"],
  // Tamil Nadu - Chennai
  "Chennai": ["Adyar", "Anna Nagar", "Egmore", "Guindy", "Mylapore", "Nungambakkam", "T. Nagar", "Tambaram", "Velachery"],
  // Tamil Nadu - Coimbatore
  "Coimbatore": ["Annur", "Coimbatore North", "Coimbatore South", "Mettupalayam", "Pollachi", "Sulur", "Valparai"],
  // Kerala - Ernakulam
  "Ernakulam": ["Aluva", "Angamaly", "Cochin", "Kalady", "Kothamangalam", "Muvattupuzha", "Perumbavoor"],
  // Kerala - Thiruvananthapuram
  "Thiruvananthapuram": ["Attingal", "Chirayinkeezhu", "Nedumangad", "Neyyattinkara", "Thiruvananthapuram City", "Varkala"],
  // Maharashtra - Mumbai City
  "Mumbai City": ["Bandra", "Borivali", "Colaba", "Dadar", "Fort", "Kurla", "Malad", "Worli"],
  // Maharashtra - Pune
  "Pune": ["Baramati", "Bhor", "Daund", "Haveli", "Indapur", "Junnar", "Maval", "Mulshi", "Pune City", "Purandar", "Shirur", "Velhe"],
  // Maharashtra - Nagpur
  "Nagpur": ["Hingna", "Kamptee", "Katol", "Kuhi", "Nagpur City", "Nagpur Rural", "Narkhed", "Parseoni", "Ramtek", "Savner", "Umred"],
  // Add default branches for zones not explicitly listed
  "Default": ["Branch 1", "Branch 2", "Branch 3", "Branch 4", "Branch 5"],
};

// Helper function to get zones for a state
export const getZonesForState = (state: string): string[] => {
  return stateZones[state] || [];
};

// Helper function to get branches for a zone
export const getBranchesForZone = (zone: string): string[] => {
  return zoneBranches[zone] || zoneBranches["Default"];
};

// Education segments
export const educationSegments = [
  "Pre Primary",
  "Primary",
  "High School",
  "Higher Secondary",
